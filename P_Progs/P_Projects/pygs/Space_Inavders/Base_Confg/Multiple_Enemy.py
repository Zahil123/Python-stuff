...
for i in range(num_of_enemies):
    ...
    enemyImg.append(pygame.image.load("alien.png"))  #Specify the enemy img
    enemyX.append(random.randint(0,750))   #Provides randomised value of X and Y coords of enemy
...
while run:
    ...
    for i in range(num_of_enemies):
        ...
        if collision:
            ...
            score_value += 1
            #print(score_value)
            enemyX[i] = random.randint(0,750)   #Spawns enemy at new location
